...
//        this.add(compressy);
        ...
        triangle.addActionListener(e -> {
            this.display.setFractal(new SierpinskiTriangle());
            this.display.repaint();
        });

        square.addActionListener(e -> {
            this.display.setFractal(new SierpinskiSquare());
            this.display.repaint();
        });

        mandelbrot.addActionListener(e -> {
            this.display.setFractal(new FractalHandler(new Mandelbrot()));
            this.display.repaint();
        });

        newton.addActionListener(e -> {
            this.display.setFractal(new FractalHandler(new NewtonFractal()));
            this.display.repaint();
        });
